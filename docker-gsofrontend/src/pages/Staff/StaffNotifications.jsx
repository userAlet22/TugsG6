...
const DashboardContent = memo(() => {
  ...
  const [selectedNotif, setSelectedNotif] = useState(null); // ← GIDUGANG
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden"> {/* ← GIBAG-O */}
          ...
          {loading ? (
            ...
            <ul className="divide-y divide-gray-100">
              {notifications.map((notif) => (
                <li
                  key={notif.id}
                  onClick={() => handleNotificationClick(notif)} // ← GIDUGANG
                ...
                >
                  ...
                  <div className="mt-2 md:mt-0 flex items-center gap-2">
                    <span className="text-xs text-blue-500"></span> {/* ← GIDUGANG */}
